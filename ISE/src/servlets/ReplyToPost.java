	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		if(tempPostContent.isEmpty()||tempPostContent == null){
			...
			if(student != null){
				...
				Post reply_post = postDAO.retrievePostbyID(postDAO.lastPostIDofAvatar(avatar_id));
				TransactionController.rewardThoughtfulnessQAcoins(reply_post, student);
				int reply_post_id = reply_post.getPost_id();
				TransactionController.requestQa_coins(student,post_id,reply_post_id);
