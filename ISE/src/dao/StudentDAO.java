...
/*	public static void main(String[] args){
    ...
    public Student retrieveStudent(String emailID, String password) {
        ...
        try {
            ...
            sql = "select smu_email_id, smu_email, tele_username, group_id, password, chat_id, veri_code, temp_smu_email_address from " + TBLNAME + " where smu_email_id = ? and password = binary?";
