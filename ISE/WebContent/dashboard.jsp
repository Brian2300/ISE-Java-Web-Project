...
<script>
	let d1Data = <%=DashboardDAO.retrieveD1data()%>
	let d2Data = <%=DashboardDAO.retrieveD2data()%>
	let d3Data = <%=DashboardDAO.retrieveD3data()%>
	let d4Data = <%=DashboardDAO.retrieveD4data()%>
